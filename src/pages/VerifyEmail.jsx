  ...
  return (
    <div className="flex items-center justify-center h-screen">
      <div className="w-full max-w-[505px] py-[29px] px-[26px] shadow-md text-center">
        ...
        <p className="bg-green-200 text-green-700 py-1.5 px-3 rounded-lg ">{feedback}</p>
        <h1 className="text-xl lg:text-[30px] font-semibold my-3">
          Verification Failed
        </h1>
        <p className="mb-4 text-[#666]">Invalid or expired Token</p>

        <button onClick={handleResendEmail} className=" font-semibold rounded-xl text-center bg-[#0c0c0c] text-[#ffffff] h-[56px] w-[123px]">
